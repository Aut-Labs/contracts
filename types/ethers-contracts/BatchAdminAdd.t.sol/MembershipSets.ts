...
export interface MembershipSetsInterface extends utils.Interface {
  functions: {
    ...
    "testSetupAdminAdd()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testSetupAdminAdd",
    values?: undefined
  ): string;
...
export interface MembershipSets extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MembershipSetsInterface;
  ...
  callStatic: {
    ...
    testSetupAdminAdd(overrides?: CallOverrides): Promise<void>;
  };
