...
export interface ModuleSkipTempInterface extends utils.Interface {
  functions: {
    ...
    "testInstallSocialBot()": FunctionFragment;
    "testPluginInstallModule()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "testInstallSocialBot"
      | "testPluginInstallModule"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testInstallSocialBot",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testPluginInstallModule",
    values?: undefined
  ): string;
...
export interface ModuleSkipTemp extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ModuleSkipTempInterface;
  ...
  callStatic: {
    ...
    testInstallSocialBot(overrides?: CallOverrides): Promise<void>;

    testPluginInstallModule(overrides?: CallOverrides): Promise<void>;
  };
