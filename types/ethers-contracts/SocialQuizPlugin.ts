...
export interface SocialQuizPluginInterface extends utils.Interface {
  functions: {
...
export interface SocialQuizPlugin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SocialQuizPluginInterface;
