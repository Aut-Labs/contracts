...
export interface TestLRFuzzInterface extends utils.Interface {
  functions: {
    ...
    "testfuzzLRFormula(uint256,uint256,uint256,uint256,uint256,uint256,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testfuzzLRFormula",
    values: [
      BigNumberish,
      BigNumberish,
      BigNumberish,
...
export interface TestLRFuzz extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestLRFuzzInterface;
