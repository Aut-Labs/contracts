...
export interface TestSocialBotPluginInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "testSocialBot",
    values?: undefined
  ): string;
...
export interface TestSocialBotPlugin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestSocialBotPluginInterface;
