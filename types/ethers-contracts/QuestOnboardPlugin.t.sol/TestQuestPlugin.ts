...
export interface TestQuestPluginInterface extends utils.Interface {
  functions: {
    ...
    "testActivateQuest()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testActivateQuest",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface TestQuestPlugin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestQuestPluginInterface;
  ...
  callStatic: {
    ...
    testActivateQuest(overrides?: CallOverrides): Promise<void>;
