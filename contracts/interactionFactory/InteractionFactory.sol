...
import "./interfaces/IInteractionFactory.sol";
...
contract InteractionFactory is ERC721, Ownable, IInteractionFactory {
    ...
    constructor(address initialOwner) 
        ERC721("Aut Interaction Template", "AIT") 
     ...
     */
    function setAutIDRegistry(address autIDAddress) external override onlyOwner {
    ...
    ) public override whenNotPaused onlyAutIDOwner returns (uint256[] memory) {
    ...
    ) public override whenNotPaused onlyAutIDOwner returns (uint256) {
     ...
     * @return tokenId Token ID of the created template
     */
    function _createInteractionTemplate(
        InteractionTemplateParams calldata params
        ...
        bytes32 uniqueHash = computeTemplateHash(
     ...
     */
    function getInteractionTemplate(uint256 tokenId) 
        external 
        view 
        override 
        returns (InteractionTemplate memory) 
    {
     ...
     */
    function getInteractionsByCreator(address creator) 
        external 
        view 
        override 
