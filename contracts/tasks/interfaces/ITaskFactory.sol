...
interface ITaskFactory {
    ...
    /// @notice Take a Contribution and encode it to calculate its' unique bytes32 representation
    function encodeContribution(Contribution memory contribution) external pure returns (bytes32);
