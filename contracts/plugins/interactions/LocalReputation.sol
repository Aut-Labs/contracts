...
contract LocalRep {
    ...
    mapping(uint256 contextID => LR[2]) getLR; // [current, last]
    ...
    struct LR {
        ...
        uint32 p; /// period  in days of not default?
     }
    ...
    function _selfAuthorise(address dao_) private {
        uint256 context = getContextID(msg.sender, dao_);
