...
contract Ecosystem is TokenVesting {
    // settings for this vesting contract

    // max amount to vest in this contract
    uint256 constant TOTAL_VEST_AMOUNT = 15000000 ether; // may not be needed as we're using the balance to check this in TokenVesting
