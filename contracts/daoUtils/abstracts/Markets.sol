...
abstract contract Market is IMarket, Ownable {
    ...
    function addMarket(string calldata marketName) public virtual override onlyOwner {
    ...
    function getMarket(uint256 _marketId) external view returns (MarketModel memory) {
